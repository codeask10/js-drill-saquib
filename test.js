...
import {getAllEmails,getHobbyByAge, getStudentName, getNameAndCityByIndex, getAllAges,getFirstHobby, getNameAndEmailByAge, getAllCityAndCountry} from "./solution.js";
...
// getNameAndEmailByAge(arrayOfObjects,25);   //Name: Bob and Email: bob@example.com
// getNameAndEmailByAge(arrayOfObjects,50);   //Age:50 is not found


getAllCityAndCountry(arrayOfObjects); // list of all city and country name
getAllCityAndCountry([]);   //Empty dataset
getAllCityAndCountry();     //Invalid Dataset